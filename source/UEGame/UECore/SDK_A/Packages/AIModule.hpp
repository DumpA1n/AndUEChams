...
struct FEQSParametrizedQueryExecutionRequest
{
	...
	EEnvQueryRunMode RunMode; // 0x40(0x1)
...
struct FBTDecoratorLogic
{
	EBTDecoratorLogic Operation; // 0x0(0x1)
...
{
	uint8_t DefaultValue : 1; // 0x30(0x1), Mask(0x1)
...
// Object: ScriptStruct AIModule.SenseIDToClassMapping
// Size: 0x30 (Inherited: 0x0)
struct FSenseIDToClassMapping
{
	uint8_t Pad_0x0[0x10]; // 0x0(0x10)
	struct TArray<struct UAISense*> RegisteredSenseTypes; // 0x10(0x10)
...
struct FEnvOverlapData
{
	...
	ECollisionChannel OverlapChannel; // 0x18(0x1)
	EEnvOverlapShape OverlapShape; // 0x19(0x1)
...
struct FEnvTraceData
{
	...
	ETraceTypeQuery TraceChannel; // 0x28(0x1)
	ECollisionChannel SerializedChannel; // 0x29(0x1)
	EEnvTraceShape TraceShape; // 0x2A(0x1)
	EEnvQueryTrace TraceMode; // 0x2B(0x1)
...
struct FEnvDirection
{
	...
	EEnvDirection DirMode; // 0x18(0x1)
	uint8_t Pad_0x19[0x7]; // 0x19(0x7)
};
...
struct UAIPerceptionComponent : UActorComponent
{
	...
	struct TArray<struct UAISenseConfig*> SensesConfig; // 0xF8(0x10)
	struct UAISense* DominantSense; // 0x108(0x8)
	uint8_t Pad_0x110[0x10]; // 0x110(0x10)
	struct AAIController* AIOwner; // 0x120(0x8)
	uint8_t Pad_0x128[0x80]; // 0x128(0x80)
	struct FMulticastInlineDelegate OnPerceptionUpdated; // 0x1A8(0x10)
	struct FMulticastInlineDelegate OnTargetPerceptionUpdated; // 0x1B8(0x10)

	// Object: Function AIModule.AIPerceptionComponent.SetSenseEnabled
	// Flags: [Final|Native|Public|BlueprintCallable]
	// Offset: 0x17772b88
	// Params: [ Num(2) Size(0x9) ]
	void SetSenseEnabled(struct UAISense* SenseClass, uint8_t bEnable);
	...
	// Offset: 0x17772a94
	// Params: [ Num(2) Size(0x9) ]
	void OnOwnerEndPlay(struct AActor* Actor, EEndPlayReason EndPlayReason);
	...
	uint8_t GetActorsPerception(struct AActor* Actor, struct FActorPerceptionBlueprintInfo& Info);
};
...
struct UBlackboardComponent : UActorComponent
{
	...
	struct UBrainComponent* BrainComp; // 0xF8(0x8)
	struct UBlackboardData* BlackboardAsset; // 0x100(0x8)
	uint8_t Pad_0x108[0x20]; // 0x108(0x20)
	struct TArray<struct UBlackboardKeyType*> KeyInstances; // 0x128(0x10)
	uint8_t Pad_0x138[0xB8]; // 0x138(0xB8)
	...
	// Offset: 0x17779f58
	// Params: [ Num(2) Size(0x9) ]
	void SetValueAsBool(const struct FName& KeyName, uint8_t BoolValue);
...
struct UBrainComponent : UActorComponent
{
	...
	struct UBlackboardComponent* BlackboardComp; // 0x100(0x8)
	struct AAIController* AIOwner; // 0x108(0x8)
	uint8_t Pad_0x110[0x48]; // 0x110(0x48)
...
struct UBehaviorTreeComponent : UBrainComponent
{
	...
	struct TArray<struct UBTNode*> NodeInstances; // 0x178(0x10)
	uint8_t Pad_0x188[0x120]; // 0x188(0x120)
	...
	void AddCooldownTagDuration(struct FGameplayTag CooldownTag, float CooldownDuration, uint8_t bAddToExistingDuration);
};
...
struct UBTDecorator : UBTAuxiliaryNode
{
	...
	EBTFlowAbortMode FlowAbortMode; // 0x59(0x1)
...
struct UEnvQueryInstanceBlueprintWrapper : UObject
{
	...
	uint8_t GetQueryResultsAsLocations(struct TArray<struct FVector>& ResultLocations);

	// Object: Function AIModule.EnvQueryInstanceBlueprintWrapper.GetQueryResultsAsActors
	// Flags: [Final|Native|Public|HasOutParms|BlueprintCallable|Const]
	// Offset: 0x1778354c
	// Params: [ Num(2) Size(0x11) ]
	uint8_t GetQueryResultsAsActors(struct TArray<struct AActor*>& ResultActors);
	...
	// Offset: 0x101d2e88
	// Params: [ Num(2) Size(0x9) ]
	void EQSQueryDoneSignature__DelegateSignature(struct UEnvQueryInstanceBlueprintWrapper* QueryInstance, EEnvQueryStatus QueryStatus);
};
...
struct UEnvQueryTest : UEnvQueryNode
{
	...
	EEnvTestPurpose TestPurpose; // 0x30(0x1)
	uint8_t Pad_0x35[0x3]; // 0x35(0x3)
	struct FString TestComment; // 0x38(0x10)
	EEnvTestFilterOperator MultipleContextFilterOp; // 0x48(0x1)
	EEnvTestScoreOperator MultipleContextScoreOp; // 0x49(0x1)
	EEnvTestFilterType FilterType; // 0x4A(0x1)
	...
	EEnvTestScoreEquation ScoringEquation; // 0xF9(0x1)
	EEnvQueryTestClamping ClampMinType; // 0xFA(0x1)
	EEnvQueryTestClamping ClampMaxType; // 0xFB(0x1)
	...
	uint8_t bDefineReferenceValue : 1; // 0x1E0(0x1), Mask(0x1)
...
struct AAIController : AController
{
	...
	uint8_t Pad_0x3E8[0x38]; // 0x3E8(0x38)
	uint8_t bStopAILogicOnUnposses : 1; // 0x420(0x1), Mask(0x1)
	uint8_t bLOSflag : 1; // 0x420(0x1), Mask(0x2)
	uint8_t bSkipExtraLOSChecks : 1; // 0x420(0x1), Mask(0x4)
	uint8_t bAllowStrafe : 1; // 0x420(0x1), Mask(0x8)
	uint8_t bWantsPlayerState : 1; // 0x420(0x1), Mask(0x10)
	uint8_t bSetControlRotationFromPawnOrientation : 1; // 0x420(0x1), Mask(0x20)
	uint8_t BitPad_0x420_6 : 2; // 0x420(0x1)
	uint8_t Pad_0x421[0x7]; // 0x421(0x7)
	struct UPathFollowingComponent* PathFollowingComponent; // 0x428(0x8)
	struct UBrainComponent* BrainComponent; // 0x430(0x8)
	struct UAIPerceptionComponent* PerceptionComponent; // 0x438(0x8)
	struct UPawnActionsComponent* ActionsComp; // 0x440(0x8)
	struct UBlackboardComponent* Blackboard; // 0x448(0x8)
	struct UGameplayTasksComponent* CachedGameplayTasksComponent; // 0x450(0x8)
	struct UNavigationQueryFilter* DefaultNavigationFilterClass; // 0x458(0x8)
	struct FMulticastInlineDelegate ReceiveMoveCompleted; // 0x460(0x10)
	uint8_t Pad_0x470[0x8]; // 0x470(0x8)

	// Object: Function AIModule.AIController.UseBlackboard
	// Flags: [Final|Native|Public|HasOutParms|BlueprintCallable]
	// Offset: 0x177722c0
	// Params: [ Num(3) Size(0x11) ]
	uint8_t UseBlackboard(struct UBlackboardData* BlackboardAsset, struct UBlackboardComponent*& BlackboardComponent);
	...
	// Offset: 0x177720cc
	// Params: [ Num(1) Size(0x1) ]
	void SetMoveBlockDetection(uint8_t bEnable);

	// Object: Function AIModule.AIController.RunBehaviorTree
	// Flags: [Native|Public|BlueprintCallable]
	// Offset: 0x17772014
	// Params: [ Num(2) Size(0x9) ]
	uint8_t RunBehaviorTree(struct UBehaviorTree* BTAsset);
	...
	EPathFollowingRequestResult MoveToLocation(const struct FVector& Dest, float AcceptanceRadius, uint8_t bStopOnOverlap, uint8_t bUsePathfinding, uint8_t bProjectDestinationToNavigation, uint8_t bCanStrafe, struct UNavigationQueryFilter* FilterClass, uint8_t bAllowPartialPath);

	// Object: Function AIModule.AIController.MoveToActor
	// Flags: [Final|Native|Public|BlueprintCallable]
	// Offset: 0x17771a4c
	// Params: [ Num(8) Size(0x1A) ]
	EPathFollowingRequestResult MoveToActor(struct AActor* Goal, float AcceptanceRadius, uint8_t bStopOnOverlap, uint8_t bUsePathfinding, uint8_t bCanStrafe, struct UNavigationQueryFilter* FilterClass, uint8_t bAllowPartialPath);
...
struct UPathFollowingComponent : UActorComponent
{
	...
	struct UNavMovementComponent* MovementComp; // 0x130(0x8)
	uint8_t Pad_0x138[0x8]; // 0x138(0x8)
	struct ANavigationData* MyNavData; // 0x140(0x8)
	uint8_t Pad_0x148[0x158]; // 0x148(0x158)
...
struct UCrowdFollowingComponent : UPathFollowingComponent
{
	...
	struct UCharacterMovementComponent* CharacterMovement; // 0x2A8(0x8)
	struct FVector CrowdAgentMoveDirection; // 0x2B0(0xC)
	uint8_t Pad_0x2BC[0x24]; // 0x2BC(0x24)

	// Object: Function AIModule.CrowdFollowingComponent.SuspendCrowdSteering
	// Flags: [Native|Public|BlueprintCallable]
	// Offset: 0x17780fd4
	// Params: [ Num(1) Size(0x1) ]
	void SuspendCrowdSteering(uint8_t bSuspend);
};
...
struct UEnvQueryTest_Distance : UEnvQueryTest
{
	...
	EEnvTestDistance TestMode; // 0x1F1(0x1)
...
struct ANavLinkProxy : AActor
{
	...
	struct TArray<struct FNavigationLink> PointLinks; // 0x380(0x10)
	struct TArray<struct FNavigationSegmentLink> SegmentLinks; // 0x390(0x10)
	struct UNavLinkCustomComponent* SmartLinkComp; // 0x3A0(0x8)
	uint8_t bSmartLinkIsRelevant : 1; // 0x3A8(0x1), Mask(0x1)
	uint8_t BitPad_0x3A8_1 : 7; // 0x3A8(0x1)
	uint8_t Pad_0x3A9[0x7]; // 0x3A9(0x7)
	struct FMulticastInlineDelegate OnSmartLinkReached; // 0x3B0(0x10)

	// Object: Function AIModule.NavLinkProxy.SetSmartLinkEnabled
	// Flags: [Final|Native|Public|BlueprintCallable]
	// Offset: 0x17786f40
	// Params: [ Num(1) Size(0x1) ]
	void SetSmartLinkEnabled(uint8_t bEnabled);
	...
	// Offset: 0x17786e64
	// Params: [ Num(1) Size(0x1) ]
	uint8_t IsSmartLinkEnabled();

	// Object: Function AIModule.NavLinkProxy.HasMovingAgents
	// Flags: [Final|Native|Public|BlueprintCallable|BlueprintPure|Const]
	// Offset: 0x17786e2c
	// Params: [ Num(1) Size(0x1) ]
	uint8_t HasMovingAgents();
};

// Object: Class AIModule.EQSTestingPawn
// Size: 0x820 (Inherited: 0x790)
struct AEQSTestingPawn : ACHARACTER
{
	DEFINE_UE_CLASS_HELPERS(AEQSTestingPawn, "EQSTestingPawn")

	struct UEnvQuery* QueryTemplate; // 0x790(0x8)
	struct TArray<struct FEnvNamedValue> QueryParams; // 0x798(0x10)
	struct TArray<struct FAIDynamicParam> QueryConfig; // 0x7A8(0x10)
	float TimeLimitPerStep; // 0x7B8(0x4)
	int32_t StepToDebugDraw; // 0x7BC(0x4)
	EEnvQueryHightlightMode HighlightMode; // 0x7C0(0x1)
	uint8_t bDrawLabels : 1; // 0x7C1(0x1), Mask(0x1)
	uint8_t bDrawFailedItems : 1; // 0x7C1(0x1), Mask(0x2)
	uint8_t bReRunQueryOnlyOnFinishedMove : 1; // 0x7C1(0x1), Mask(0x4)
	uint8_t bShouldBeVisibleInGame : 1; // 0x7C1(0x1), Mask(0x8)
	uint8_t bTickDuringGame : 1; // 0x7C1(0x1), Mask(0x10)
	uint8_t BitPad_0x7C1_5 : 3; // 0x7C1(0x1)
	EEnvQueryRunMode QueryingMode; // 0x7C2(0x1)
	uint8_t Pad_0x7C3[0x5]; // 0x7C3(0x5)
	struct FNavAgentProperties NavAgentProperties; // 0x7C8(0x30)
	uint8_t Pad_0x7F8[0x28]; // 0x7F8(0x28)
};
...
struct UAIAsyncTaskBlueprintProxy : UObject
{
	...
	void OnMoveCompleted(struct FAIRequestID requestId, EPathFollowingResult MovementResult);
};
...
struct UAIBlueprintHelperLibrary : UBlueprintFunctionLibrary
{
	...
	static void UnlockAIResourcesWithAnimation(struct UAnimInstance* AnimInstance, uint8_t bUnlockMovement, uint8_t UnlockAILogic);

	// Object: Function AIModule.AIBlueprintHelperLibrary.SpawnAIFromClass
	// Flags: [Final|Native|Static|Public|HasDefaults|BlueprintCallable]
	// Offset: 0x17771164
	// Params: [ Num(8) Size(0x48) ]
	static struct APawn* SpawnAIFromClass(struct UObject* WorldContextObject, struct APawn* PawnClass, struct UBehaviorTree* BehaviorTree, struct FVector Location, struct FRotator Rotation, uint8_t bNoCollisionFail, struct UObject* ArchtypeClass);
	...
	static void SendAIMessage(struct APawn* Target, struct FName Message, struct UObject* MessageSource, uint8_t bSuccess);

	// Object: Function AIModule.AIBlueprintHelperLibrary.LockAIResourcesWithAnimation
	// Flags: [Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable]
	// Offset: 0x17770d4c
	// Params: [ Num(3) Size(0xA) ]
	static void LockAIResourcesWithAnimation(struct UAnimInstance* AnimInstance, uint8_t bLockMovement, uint8_t LockAILogic);

	// Object: Function AIModule.AIBlueprintHelperLibrary.IsValidAIRotation
	// Flags: [Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure]
	// Offset: 0x17770ca4
	// Params: [ Num(2) Size(0xD) ]
	static uint8_t IsValidAIRotation(struct FRotator Rotation);

	// Object: Function AIModule.AIBlueprintHelperLibrary.IsValidAILocation
	// Flags: [Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure]
	// Offset: 0x17770bfc
	// Params: [ Num(2) Size(0xD) ]
	static uint8_t IsValidAILocation(struct FVector Location);

	// Object: Function AIModule.AIBlueprintHelperLibrary.IsValidAIDirection
	// Flags: [Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure]
	// Offset: 0x17770b54
	// Params: [ Num(2) Size(0xD) ]
	static uint8_t IsValidAIDirection(struct FVector DirectionVector);
	...
	static struct UAIAsyncTaskBlueprintProxy* CreateMoveToProxyObject(struct UObject* WorldContextObject, struct APawn* Pawn, struct FVector Destination, struct AActor* TargetActor, float AcceptanceRadius, uint8_t bStopOnOverlap);
};
...
struct UAIDataProvider_QueryParams : UAIDataProvider
{
	...
	uint8_t BoolValue : 1; // 0x38(0x1), Mask(0x1)
...
struct UAIPerceptionStimuliSourceComponent : UActorComponent
{
	...
	uint8_t bAutoRegisterAsSource : 1; // 0xF8(0x1), Mask(0x1)
	uint8_t BitPad_0xF8_1 : 7; // 0xF8(0x1)
	uint8_t Pad_0xF9[0x7]; // 0xF9(0x7)
	struct TArray<struct UAISense*> RegisterAsSourceForSenses; // 0x100(0x10)
...
struct UAIPerceptionSystem : UAISubsystem
{
	...
	float PerceptionAgingRate; // 0x88(0x4)
	uint8_t Pad_0x8C[0x8C]; // 0x8C(0x8C)
	struct TArray<struct FSenseIDToClassMapping> SensesMapping; // 0x118(0x10)
	...
	// Offset: 0x17773074
	// Params: [ Num(4) Size(0x19) ]
	static uint8_t RegisterPerceptionStimuliSource(struct UObject* WorldContextObject, struct UAISense* Sense, struct AActor* Target);

	// Object: Function AIModule.AIPerceptionSystem.OnPerceptionStimuliSourceEndPlay
	// Flags: [Final|Native|Protected]
	// Offset: 0x17772f94
	// Params: [ Num(2) Size(0x9) ]
	void OnPerceptionStimuliSourceEndPlay(struct AActor* Actor, EEndPlayReason EndPlayReason);

	// Object: Function AIModule.AIPerceptionSystem.GetSenseClassForStimulus
	// Flags: [Final|Native|Static|Public|HasOutParms|BlueprintCallable]
	// Offset: 0x17772e24
	// Params: [ Num(3) Size(0x58) ]
	static struct TArray<struct UAISense*> GetSenseClassForStimulus(struct UObject* WorldContextObject, const struct FAIStimulus& Stimulus);
};
...
struct UAISense_Sight : UAISense
{
	...
	uint8_t Pad_0x78[0xB0]; // 0x78(0xB0)
	int32_t MaxTracesPerTick; // 0x128(0x4)
	int32_t MinQueriesPerTimeSliceCheck; // 0x12C(0x4)
	double MaxTimeSlicePerTick; // 0x130(0x8)
	float HighImportanceQueryDistanceThreshold; // 0x138(0x4)
	uint8_t Pad_0x13C[0x4]; // 0x13C(0x4)
	float MaxQueryImportance; // 0x140(0x4)
	float SightLimitQueryImportance; // 0x144(0x4)
...
struct UAISystem : UAISystemBase
{
	...
	uint8_t bFinishMoveOnGoalOverlap : 1; // 0x94(0x1), Mask(0x1)
	uint8_t BitPad_0x94_1 : 7; // 0x94(0x1)
	uint8_t bAcceptPartialPaths : 1; // 0x95(0x1), Mask(0x1)
	uint8_t BitPad_0x95_1 : 7; // 0x95(0x1)
	uint8_t bAllowStrafing : 1; // 0x96(0x1), Mask(0x1)
	uint8_t BitPad_0x96_1 : 7; // 0x96(0x1)
	uint8_t bEnableBTAITasks : 1; // 0x97(0x1), Mask(0x1)
	uint8_t BitPad_0x97_1 : 7; // 0x97(0x1)
	uint8_t bAllowControllersAsEQSQuerier : 1; // 0x98(0x1), Mask(0x1)
	uint8_t BitPad_0x98_1 : 7; // 0x98(0x1)
	uint8_t bEnableDebuggerPlugin : 1; // 0x99(0x1), Mask(0x1)
	uint8_t BitPad_0x99_1 : 7; // 0x99(0x1)
	ECollisionChannel DefaultSightCollisionChannel; // 0x9A(0x1)
...
struct UBTComposite_SimpleParallel : UBTCompositeNode
{
	...
	EBTParallelMode FinishMode; // 0x8C(0x1)
};
...
struct UBTDecorator_Blackboard : UBTDecorator_BlackboardBase
{
	...
	EBTBlackboardRestart NotifyObserver; // 0xB1(0x1)
...
struct UBTDecorator_BlueprintBase : UBTDecorator
{
	...
	// Offset: 0x101d2e88
	// Params: [ Num(3) Size(0x11) ]
	void ReceiveExecutionFinishAI(struct AAIController* OwnerController, struct APawn* ControlledPawn, EBTNodeResult NodeResult);

	// Object: Function AIModule.BTDecorator_BlueprintBase.ReceiveExecutionFinish
	// Flags: [Event|Protected|BlueprintEvent]
	// Offset: 0x101d2e88
	// Params: [ Num(2) Size(0x9) ]
	void ReceiveExecutionFinish(struct AActor* OwnerActor, EBTNodeResult NodeResult);

	// Object: Function AIModule.BTDecorator_BlueprintBase.PerformConditionCheckAI
	// Flags: [Event|Protected|BlueprintEvent]
	// Offset: 0x101d2e88
	// Params: [ Num(3) Size(0x11) ]
	uint8_t PerformConditionCheckAI(struct AAIController* OwnerController, struct APawn* ControlledPawn);

	// Object: Function AIModule.BTDecorator_BlueprintBase.PerformConditionCheck
	// Flags: [Event|Protected|BlueprintEvent]
	// Offset: 0x101d2e88
	// Params: [ Num(2) Size(0x9) ]
	uint8_t PerformConditionCheck(struct AActor* OwnerActor);

	// Object: Function AIModule.BTDecorator_BlueprintBase.IsDecoratorObserverActive
	// Flags: [Final|Native|Protected|BlueprintCallable|BlueprintPure|Const]
	// Offset: 0x1777b6a0
	// Params: [ Num(1) Size(0x1) ]
	uint8_t IsDecoratorObserverActive();

	// Object: Function AIModule.BTDecorator_BlueprintBase.IsDecoratorExecutionActive
	// Flags: [Final|Native|Protected|BlueprintCallable|BlueprintPure|Const]
	// Offset: 0x1777b668
	// Params: [ Num(1) Size(0x1) ]
	uint8_t IsDecoratorExecutionActive();
};
...
struct UBTDecorator_CompareBBEntries : UBTDecorator
{
	...
	EBlackBoardEntryComparison Operator; // 0x5A(0x1)
...
struct UBTDecorator_DoesPathExist : UBTDecorator
{
	...
	EPathExistanceQueryType PathQueryType; // 0xB1(0x1)
	uint8_t Pad_0xB2[0x6]; // 0xB2(0x6)
...
struct UBTDecorator_Loop : UBTDecorator
{
	...
	uint8_t bInfiniteLoop : 1; // 0x60(0x1), Mask(0x1)
...
struct UBTDecorator_SetTagCooldown : UBTDecorator
{
	...
	uint8_t bAddToExistingDuration : 1; // 0x68(0x1), Mask(0x1)
...
struct UBTDecorator_TagCooldown : UBTDecorator
{
	...
	float CooldownDuration; // 0x64(0x4)
	uint8_t bAddToExistingDuration : 1; // 0x68(0x1), Mask(0x1)
	uint8_t bActivatesCooldown : 1; // 0x69(0x1), Mask(0x1)
...
struct UBTFunctionLibrary : UBlueprintFunctionLibrary
{
	...
	// Offset: 0x1777e374
	// Params: [ Num(3) Size(0x31) ]
	static void SetBlackboardValueAsBool(struct UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key, uint8_t Value);
	...
	// Offset: 0x1777d7c4
	// Params: [ Num(3) Size(0x31) ]
	static uint8_t GetBlackboardValueAsBool(struct UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key);
...
struct UBTTask_SetTagCooldown : UBTTaskNode
{
	...
	uint8_t bAddToExistingDuration : 1; // 0x74(0x1), Mask(0x1)
...
struct UEnvQueryGenerator_Donut : UEnvQueryGenerator_ProjectedPoints
{
	...
	uint8_t bUseSpiralPattern : 1; // 0x1B8(0x1), Mask(0x1)
...
struct UEnvQueryGenerator_OnCircle : UEnvQueryGenerator_ProjectedPoints
{
	...
	uint8_t bIgnoreAnyContextActorsWhenGeneratingCircle : 1; // 0x198(0x1), Mask(0x1)
...
struct UEnvQueryManager : UAISubsystem
{
	...
	uint8_t bTestQueriesUsingBreadth : 1; // 0x130(0x1), Mask(0x1)
	...
	static struct UEnvQueryInstanceBlueprintWrapper* RunEQSQuery(struct UObject* WorldContextObject, struct UEnvQuery* QueryTemplate, struct UObject* Querier, EEnvQueryRunMode RunMode, struct UEnvQueryInstanceBlueprintWrapper* WrapperClass);
};
...
struct UEnvQueryTest_Dot : UEnvQueryTest
{
	...
	uint8_t bAbsoluteValue : 1; // 0x239(0x1), Mask(0x1)
	uint8_t BitPad_0x239_1 : 7; // 0x239(0x1)
...
struct UEnvQueryTest_GameplayTags : UEnvQueryTest
{
	...
	uint8_t bUpdatedToUseQuery : 1; // 0x240(0x1), Mask(0x1)
...
struct UEnvQueryTest_Pathfinding : UEnvQueryTest
{
	...
	EEnvTestPathfinding TestMode; // 0x1F1(0x1)
...
struct UEQSRenderingComponent : UPrimitiveComponent
{
	...
	uint8_t Pad_0x580[0x30]; // 0x580(0x30)
};
...
struct UGridPathFollowingComponent : UPathFollowingComponent
{
	...
	struct UNavLocalGridManager* GridManager; // 0x2A0(0x8)
	uint8_t Pad_0x2A8[0x28]; // 0x2A8(0x28)
};
...
struct UNavLocalGridManager : UObject
{
	...
	// Offset: 0x17787a60
	// Params: [ Num(3) Size(0xD) ]
	static uint8_t SetLocalNavigationGridDensity(struct UObject* WorldContextObject, float CellSize);

	// Object: Function AIModule.NavLocalGridManager.RemoveLocalNavigationGrid
	// Flags: [Final|Native|Static|Public|BlueprintCallable]
	// Offset: 0x17787950
	// Params: [ Num(3) Size(0xD) ]
	static void RemoveLocalNavigationGrid(struct UObject* WorldContextObject, int32_t GridID, uint8_t bRebuildGrids);

	// Object: Function AIModule.NavLocalGridManager.FindLocalNavigationGridPath
	// Flags: [Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable]
	// Offset: 0x177877bc
	// Params: [ Num(5) Size(0x31) ]
	static uint8_t FindLocalNavigationGridPath(struct UObject* WorldContextObject, const struct FVector& Start, const struct FVector& End, struct TArray<struct FVector>& PathPoints);

	// Object: Function AIModule.NavLocalGridManager.AddLocalNavigationGridForPoints
	// Flags: [Final|Native|Static|Public|HasOutParms|BlueprintCallable]
	// Offset: 0x17787608
	// Params: [ Num(6) Size(0x28) ]
	static int32_t AddLocalNavigationGridForPoints(struct UObject* WorldContextObject, const struct TArray<struct FVector>& Locations, int32_t Radius2D, float Height, uint8_t bRebuildGrids);

	// Object: Function AIModule.NavLocalGridManager.AddLocalNavigationGridForPoint
	// Flags: [Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable]
	// Offset: 0x17787460
	// Params: [ Num(6) Size(0x24) ]
	static int32_t AddLocalNavigationGridForPoint(struct UObject* WorldContextObject, const struct FVector& Location, int32_t Radius2D, float Height, uint8_t bRebuildGrids);

	// Object: Function AIModule.NavLocalGridManager.AddLocalNavigationGridForCapsule
	// Flags: [Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable]
	// Offset: 0x17787244
	// Params: [ Num(8) Size(0x2C) ]
	static int32_t AddLocalNavigationGridForCapsule(struct UObject* WorldContextObject, const struct FVector& Location, float CapsuleRadius, float CapsuleHalfHeight, int32_t Radius2D, float Height, uint8_t bRebuildGrids);

	// Object: Function AIModule.NavLocalGridManager.AddLocalNavigationGridForBox
	// Flags: [Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable]
	// Offset: 0x17787024
	// Params: [ Num(8) Size(0x3C) ]
	static int32_t AddLocalNavigationGridForBox(struct UObject* WorldContextObject, const struct FVector& Location, struct FVector Extent, struct FRotator Rotation, int32_t Radius2D, float Height, uint8_t bRebuildGrids);
};
...
struct UPawnAction_BlueprintBase : UPawnAction
{
	...
	// Offset: 0x101d2e88
	// Params: [ Num(2) Size(0x9) ]
	void ActionFinished(struct APawn* ControlledPawn, EPawnActionResult WithResult);
};
...
struct UPawnAction_Repeat : UPawnAction
{
	...
	EPawnActionFailHandling ChildFailureHandlingMode; // 0xA8(0x1)
...
struct UPawnActionsComponent : UActorComponent
{
	...
	struct APawn* ControlledPawn; // 0xF8(0x8)
	struct TArray<struct FPawnActionStack> ActionStacks; // 0x100(0x10)
	struct TArray<struct FPawnActionEvent> ActionEvents; // 0x110(0x10)
	struct UPawnAction* CurrentAction; // 0x120(0x8)
	...
	// Offset: 0x17788b44
	// Params: [ Num(4) Size(0x19) ]
	uint8_t K2_PushAction(struct UPawnAction* NewAction, EAIRequestPriority Priority, struct UObject* Instigator);

	// Object: Function AIModule.PawnActionsComponent.K2_PerformAction
	// Flags: [Final|Native|Static|Public|BlueprintCallable]
	// Offset: 0x17788a28
	// Params: [ Num(4) Size(0x12) ]
	static uint8_t K2_PerformAction(struct APawn* Pawn, struct UPawnAction* Action, EAIRequestPriority Priority);

	// Object: Function AIModule.PawnActionsComponent.K2_ForceAbortAction
	// Flags: [Final|Native|Public|BlueprintCallable]
	// Offset: 0x1778897c
	// Params: [ Num(2) Size(0x9) ]
	EPawnActionAbortState K2_ForceAbortAction(struct UPawnAction* ActionToAbort);

	// Object: Function AIModule.PawnActionsComponent.K2_AbortAction
	// Flags: [Final|Native|Public|BlueprintCallable]
	// Offset: 0x177888d0
	// Params: [ Num(2) Size(0x9) ]
	EPawnActionAbortState K2_AbortAction(struct UPawnAction* ActionToAbort);
};
...
struct UPawnSensingComponent : UActorComponent
{
	...
	float HearingThreshold; // 0xF8(0x4)
	float LOSHearingThreshold; // 0xFC(0x4)
	float SightRadius; // 0x100(0x4)
	float SensingInterval; // 0x104(0x4)
	float HearingMaxSoundAge; // 0x108(0x4)
	uint8_t bEnableSensingUpdates : 1; // 0x10C(0x1), Mask(0x1)
	uint8_t bOnlySensePlayers : 1; // 0x10C(0x1), Mask(0x2)
	uint8_t bSeePawns : 1; // 0x10C(0x1), Mask(0x4)
	uint8_t bHearNoises : 1; // 0x10C(0x1), Mask(0x8)
	uint8_t BitPad_0x10C_4 : 4; // 0x10C(0x1)
	uint8_t Pad_0x10D[0xB]; // 0x10D(0xB)
	struct FMulticastInlineDelegate OnSeePawn; // 0x118(0x10)
	struct FMulticastInlineDelegate OnHearNoise; // 0x128(0x10)
	float PeripheralVisionAngle; // 0x138(0x4)
	float PeripheralVisionCosine; // 0x13C(0x4)
	...
	// Offset: 0x17788e1c
	// Params: [ Num(1) Size(0x1) ]
	void SetSensingUpdatesEnabled(uint8_t bEnabled);
