...
// Package: CoreUObject - Classes(59)
...
struct UObject
{
	...
	void** VTable; // 0x0(0x8)
	uint32_t ObjectFlags; // 0x8(0x4)
	int32_t InternalIndex; // 0xC(0x4)
	struct UClass* ClassPrivate; // 0x10(0x8)
	FName NamePrivate; // 0x18(0x8)
	struct UObject* OuterPrivate; // 0x20(0x8)
...
struct UStruct : UField
{
	...
	struct UField* Children; // 0x48(0x8)
	struct FField* ChildProperties; // 0x50(0x8)
	int32_t PropertiesSize; // 0x58(0x4)
	uint8_t Pad_0x5C[0x54]; // 0x5C(0x54)
};
...
struct UClass : UStruct
{
	...
	EClassCastFlags CastFlags; // 0xD0(0x8)
	uint8_t Pad_0xD8[0x40]; // 0xD8(0x40)
	struct UObject* DefaultObject; // 0x118(0x8)
	uint8_t Pad_0x120[0x140]; // 0x120(0x140)
...
struct UFunction : UStruct
{
	...
	uint32_t EFunctionFlags; // 0xB0(0x4)
	uint8_t NumParams; // 0xB4(0x1)
	uint8_t Pad_0xB5[0x1]; // 0xB5(0x1)
	uint16_t ParamSize; // 0xB6(0x2)
